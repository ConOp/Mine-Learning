...
public class SettingsManager {
    ...
    public static int chromosomeLength=200;
    public static int agentsPerGeneration=1000;
    ...
    public static float chanceMutationToHappen=0.1f;
    public static float chanceToMutate=0.25f;
